...
import me.bumiller.civoris.core.mapping.mapInvitation
import me.bumiller.civoris.core.mapping.mapStatus
import me.bumiller.civoris.core.mapping.memberRoleToString
import me.bumiller.civoris.database.repository.BookInvitationRepository
import me.bumiller.civoris.database.repository.LawBookRepository
...
internal class DatabaseInvitationContentService(
    ...
    override suspend fun createInvitation(
        ...
        val invitation = invitationRepository.create(
            model = me.bumiller.civoris.database.table.BookInvitation.Model(
                id = -1,
                author = author,
                targetBook = book,
                recipient = recipient,
                ...
                usedAt = null,
                status = me.bumiller.civoris.database.table.BookInvitation.Status.Open,
                expiresAt = expiresAt,
                message = message
            ),
            authorId = author.id,
