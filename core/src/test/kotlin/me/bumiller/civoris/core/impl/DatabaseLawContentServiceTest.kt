...
import me.bumiller.civoris.test.util.*
...
class DatabaseLawContentServiceTest {
    ...
    fun `createBook calls repository with correctly created book model and returns created book`() =
        runTest {
            ...
            val bookSlot = slot<me.bumiller.civoris.database.table.LawBook.Model>()
    ...
    fun `createEntry correctly creates entry model and returns result`() = runTest {
        ...
        val entrySlot = slot<me.bumiller.civoris.database.table.LawEntry.Model>()
